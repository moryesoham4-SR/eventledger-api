...
from routers import auth, events, departments, budget, income, expenses, sponsors, vendors, notifications, users, event_data, reports, activity, vendor_quotes, sponsorship, roi, tasks
